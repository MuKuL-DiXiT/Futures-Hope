...
// 🔸 Create or fetch one-to-one chat (unchanged)
...
// 🔹 Get all chats for user (includes community chats)
...
// 🔸 Send message (updated with community checks)
...
// 🔹 Delete message (supports moderator privilege)
