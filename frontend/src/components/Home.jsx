...
export default function Home() {
  ...
  const logout = async () => {
    try {
      await secureFetch("/auth/logout", { method: "GET" });
      navigate("/");
    } catch (error) {
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-16 justify-between">
              <div className="group">
                <NavLink
                  to="/createCommunity"
                  className="text-gray-700 hover:text-gray-900 group-hover:hidden"
                >
              ...
              <div className="group">
                <button
                  onClick={logout}
                  className="text-gray-700 hover:text-gray-900 mt-1 group-hover:hidden"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
