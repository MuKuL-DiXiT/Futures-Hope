                ...
                <div className="flex flex-col gap-1 items-start">
                  ...
                  <p className="text-xs text-wrap text-amber-700">
                    {typeof lastMsg === "object" && lastMsg.readBy?.length === 2
                      ? lastMsg.content
                      : (<span className="flex items-center justify-center text-red-600 gap-1"><span className="text-4xl leading-none">•</span><span className="text-xs">new message</span></span>)}
                  </p>
                </div>
              </button>
            </div>
